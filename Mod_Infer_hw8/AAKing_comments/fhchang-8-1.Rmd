...
> Would be good to reproduce the figure here, rather than below.
...
> Interesting. Note that $p_0=0$ is plausible. Do you see why that has to be so?
...
> Looks good. Can you plot this with the appropriate confidence intervals as well?
...
> Show the equations here, and derive the corresponding c.d.f.!
...
> What does it mean that the point estimate is on the boundary?
...
> My understanding is that you have a more intuitive model that you want to use on the next draft. I will save more comments for that.
...
> You can do all this with one call to `AIC`, I think.
...
> Therefore, you should be able to do better, no?

 This makes me wonder if there is another link function that also have this kind of feature.  
 
> Or a better mechanistic model....

> Really nice job, so far. I expect even better to come soon.
