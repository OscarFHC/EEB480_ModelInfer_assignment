---
title: "Assignment 8-2 Maximum Likelihood Lab"
...
> You might consider adding a few sentences to introduce the reader to the data set (i.e. that you are looking at seropositivity in Gopher tortoises). 
...
```{r, ecoh=FALSE, message=FALSE, warning=FALSE}
...
> Perhaps you could be a little more explicit about why this model is an improvement on your first model. If this models describes how much the probability of seropositivity changes when an individual grows, what does the first model do? 
...
> Why is a rounded surface more informative? 
...
> Explain how this plot is useful/should be interpreted. It might not be necessary to include, if you don't want or need to discuss it. The title seems a little funky. 
...
> Jittering the observed data might be useful. It's a bit difficult to tell where they are clumped. 
...
> Why did you choose the Michaelis Menton equation? 
...
> Again, could/should you "jitter" the observed data? 
...
> Make it clear you are testing a different model below. 
...
> Include the prompt for this exercise, as you did with exercises 1 through 3. I believe we were also asked to comment on any other models suggested by the data or methods of testing our models that might be appropriate. 
...
> Overall, very nice assignment. I tried to point out a few places where you could make your worker clearer to a naive reader, but feel free to incorporate or ignore the suggestions as you see fit! 